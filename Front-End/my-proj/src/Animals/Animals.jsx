...
function Animals() {
  ...
  choose: [
    { id: '1', image: '/public/images/tiger.jpg', title: 'Choose - Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/1',difficulty: 'easy' },
    { id: '2', image: '/public/images/tiger.jpg', title: 'Choose - Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/2', difficulty: 'easy' },
    { id: '3', image: '/public/images/tiger.jpg', title: 'Choose - Unit-3', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/3', difficulty: 'easy' },
    { id: '4', image: '/public/images/tiger.jpg', title: 'Choose - Unit-4', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/4', difficulty: 'medium' },
    // { id: '5', image: '/public/images/tiger.jpg', title: 'Choose - Unit-5', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/5', difficulty: 'medium' },
    // { id: '6', image: '/public/images/tiger.jpg', title: 'Choose - Unit-6', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/6', difficulty: 'medium' },
    { id: '7', image: '/public/images/tiger.jpg', title: 'Choose - Unit-7', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/7', difficulty: 'hard' },
    // { id: '8', image: '/public/images/tiger.jpg', title: 'Choose - Unit-8', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/8', difficulty: 'hard' },
    // { id: '9', image: '/public/images/tiger.jpg', title: 'Choose - Unit-9', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'animals/choose/9', difficulty: 'hard' },
  ],
  fillUps: [
    { id: '1', image: '/public/images/tiger.jpg', title: 'Fill Ups Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'animals/fill-ups/1', difficulty: 'easy' },
    { id: '2', image: '/public/images/tiger.jpg', title: 'Fill Ups Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'animals/fill-ups/2', difficulty: 'easy' },
    { id: '3', image: '/public/images/tiger.jpg', title: 'Fill Ups Unit-3', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'animals/fill-ups/3', difficulty: 'easy' },
  ],
  guessByImage: [
    { id: '1', image: '/public/images/tiger.jpg', title: 'Guess by Image Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'guess-by-image', keyword: 'animals/guess-by-image/1', difficulty: 'easy' },
    { id: '2', image: '/public/images/tiger.jpg', title: 'Guess by Image Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'guess-by-image', keyword: 'animals/guess-by-image/2', difficulty: 'easy' },
  ]
};
...
const handleDifficultyClick = (difficulty) => {
  ...
  navigate(`/animals/${selectedQuizType}/?difficulty=${difficulty.toUpperCase()}`);
  setLoader(false);
};
...
const handleStatus = (status) => {
  ...
  navigate(`/animals/${selectedQuizType}/?status=${status.toUpperCase()}`);
  setLoader(false);
};
    ...
    <div className={styles.flexContainer}>
      <div className={styles.inlineText}>
        ...
        <p className={styles.inlineText}>
          In this block we prepared a series of basic level to advanced level &quot;Animals&quot; quizes with different level of games, people can engage there knowledge in this segment
          <br/>
          <br />
      ...
      <nav aria-label="Page navigation example">
        ...
        <li className={`${styles.pageItem} ${activePage === 'All' ? styles.active : ''}`}
          ...
          <li className={`${styles.pageItem} ${activePage === 'Fill ups' ? styles.active : ''}`}
            ...
            <Link to='/animals/guess-by-image'>
          <li className={`${styles.pageItem} ${activePage === 'Guess by image' ? styles.active : ''}`}
            ...
            <Link to='/animals/mixed-type-quiz'>

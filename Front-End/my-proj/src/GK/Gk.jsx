...
function Gk() {
  ...
  choose: [
    { id: '1', image: '/public/images/gk.png', title: 'Choose - Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/1',difficulty: 'easy' },
    { id: '2', image: '/public/images/gk.png', title: 'Choose - Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/2', difficulty: 'easy' },
    { id: '3', image: '/public/images/gk.png', title: 'Choose - Unit-3', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/3', difficulty: 'easy' },
    { id: '4', image: '/public/images/gk.png', title: 'Choose - Unit-4', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/4', difficulty: 'medium' },
    // { id: '5', image: '/public/images/gk.png', title: 'Choose - Unit-5', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/5', difficulty: 'medium' },
    // { id: '6', image: '/public/images/gk.png', title: 'Choose - Unit-6', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/6', difficulty: 'medium' },
    { id: '7', image: '/public/images/gk.png', title: 'Choose - Unit-7', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/7', difficulty: 'hard' },
    // { id: '8', image: '/public/images/gk.png', title: 'Choose - Unit-8', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/8', difficulty: 'hard' },
    // { id: '9', image: '/public/images/gk.png', title: 'Choose - Unit-9', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'gk/choose/9', difficulty: 'hard' },
  ],
  fillUps: [
    { id: '1', image: '/public/images/gk.png', title: 'Fill Ups Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'gk/fill-ups/1', difficulty: 'easy' },
    { id: '2', image: '/public/images/gk.png', title: 'Fill Ups Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'gk/fill-ups/2', difficulty: 'easy' },
    { id: '3', image: '/public/images/gk.png', title: 'Fill Ups Unit-3', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'gk/fill-ups/3', difficulty: 'easy' },
  ],
  guessByImage: [
    { id: '1', image: '/public/images/gk.png', title: 'Guess by Image Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'guess-by-image', keyword: 'gk/guess-by-image/1', difficulty: 'easy' },
    { id: '2', image: '/public/images/gk.png', title: 'Guess by Image Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'guess-by-image', keyword: 'gk/guess-by-image/2', difficulty: 'easy' },
  ]
};
...
useEffect(() => {
  if (!userCredentials || !quizCardData) return;

  const updatedData = { ...quizCardData };
  let hasChanged = false;

  Object.keys(quizCardData).forEach((tag) => {
    updatedData[tag] = quizCardData[tag].map((quiz) => {
...
const handleStatus = (status) => {
  ...
  navigate(`/gk/${selectedQuizType}/?status=${status.toUpperCase()}`);
  setLoader(false);
};

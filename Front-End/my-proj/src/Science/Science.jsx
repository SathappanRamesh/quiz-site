...
function Science() {
  ...
  choose: [
    { id: '1', image: '/public/images/science.jpg', title: 'Choose - Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/1',difficulty: 'easy' },
    { id: '2', image: '/public/images/science.jpg', title: 'Choose - Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/2', difficulty: 'easy' },
    { id: '3', image: '/public/images/science.jpg', title: 'Choose - Unit-3', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/3', difficulty: 'easy' },
    { id: '4', image: '/public/images/science.jpg', title: 'Choose - Unit-4', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/4', difficulty: 'medium' },
    // { id: '5', image: '/public/images/science.jpg', title: 'Choose - Unit-5', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/5', difficulty: 'medium' },
    // { id: '6', image: '/public/images/science.jpg', title: 'Choose - Unit-6', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/6', difficulty: 'medium' },
    { id: '7', image: '/public/images/science.jpg', title: 'Choose - Unit-7', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/7', difficulty: 'hard' },
    // { id: '8', image: '/public/images/science.jpg', title: 'Choose - Unit-8', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/8', difficulty: 'hard' },
    // { id: '9', image: '/public/images/science.jpg', title: 'Choose - Unit-9', score: '-', coins: 0, isCompleted: false, tag: 'choose', keyword: 'science/choose/9', difficulty: 'hard' },
  ],
  fillUps: [
    { id: '1', image: '/public/images/science.jpg', title: 'Fill Ups Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'science/fill-ups/1', difficulty: 'easy' },
    { id: '2', image: '/public/images/science.jpg', title: 'Fill Ups Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'science/fill-ups/2', difficulty: 'easy' },
    { id: '3', image: '/public/images/science.jpg', title: 'Fill Ups Unit-3', score: '-', coins: 0, isCompleted: false, tag: 'fill-ups', keyword: 'science/fill-ups/3', difficulty: 'easy' },
  ],
  guessByImage: [
    { id: '1', image: '/public/images/science.jpg', title: 'Guess by Image Unit-1', score: '-', coins: 0, isCompleted: false, tag: 'guess-by-image', keyword: 'science/guess-by-image/1', difficulty: 'easy' },
    { id: '2', image: '/public/images/science.jpg', title: 'Guess by Image Unit-2', score: '-', coins: 0, isCompleted: false, tag: 'guess-by-image', keyword: 'science/guess-by-image/2', difficulty: 'easy' },
  ]
};
  const [quizCardData, setQuizCardData] = useState(QuizMCQCardData);

     const { refreshUserCredentials } = useUser();
  // fetch userCredentials data when rendered
    useEffect(() => {
...
const getFilteredQuizzes = () => {
  ...
  if (searchBarValue !== '') {
    quizzesByType.map((curr) => {
      ...
      for (let i = 0; i < title.length; i++) {// Choose - Unit-1
...
function getRandomInt() {
  ...
  console.log(`/${currSetOfCards?.[randomNo]?.keyword}`);
...
const handleDifficultyClick = (difficulty) => {
  ...
  navigate(`/science/${selectedQuizType}/?difficulty=${difficulty.toUpperCase()}`);
  setLoader(false);
};
...
const handleStatus = (status) => {
  ...
  navigate(`/science/${selectedQuizType}/?status=${status.toUpperCase()}`);
  setLoader(false);
};
    ...
    <div className={styles.flexContainer}>
      <div className={styles.inlineText}>
        ...
        <p className={styles.inlineText}>
          In this block we prepared a series of basic level to advanced level &quot;Science&quot; quizes with different level of games, people can engage there knowledge in this segment
          <br/>
          <br />
      ...
      <nav aria-label="Page navigation example">
        ...
        <li className={`${styles.pageItem} ${activePage === 'All' ? styles.active : ''}`}
          ...
          <li className={`${styles.pageItem} ${activePage === 'Fill ups' ? styles.active : ''}`}
            ...
            <Link to='/science/guess-by-image'>
          <li className={`${styles.pageItem} ${activePage === 'Guess by image' ? styles.active : ''}`}
            ...
            <Link to='/science/mixed-type-quiz'>
